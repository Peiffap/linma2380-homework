...
\begin{exampleblock}{Introduction and Motivation}
TO DO
\end{exampleblock}
...
\begin{defn}
TO DO
Let $H \in (0,1)$. A fractional Brownian motion (fBm) $ (B^H(t))_{t\geq 0}$ of Hurst index $H$ is a continuous and centered Gaussian process with co-variance function
\begin{equation}
